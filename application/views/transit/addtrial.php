        ...
        <div class="box box-success">
          <div class="box-header  with-border">
            <ul class="nav nav-tabs box-teal bg-white">
              ...
              <button onclick="window.location.href='/sampletrace/registrasi/addtrial'" style="background-color: #09ad9e; color: white;" class="btn btn-danger  btn-social " type="button"> <i class="fa fa-plus"></i> <b>Registrasi Trial </b>
              </button>
            ...
            <center>
              <div class="box box-success ">
                <div class="box-header with-border  " style="background-color:#09ad9e; color:white;">
                  ...
                  <center>
                    <b></b>
                    <h4>Registrasi Surat Sample (Trial)</h4>
                </div>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                      <b><input type="text" class="form-control" name="kategori" requiredd="" value="Trial  " readonly /> </b>
                    </div>
