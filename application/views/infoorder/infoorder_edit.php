...
<div class="row">
  ...
  <div class="col-sm-6">
    <div class="card" style="background-color: #fff;">
      ...
      <div class="card-body">
        <?php
        echo form_open_multipart('infoorder/edit', 'role="form" class="form-horizontal"');
        ?>
...
<br>
      ...
      <div class=" card-body">
          ...
          <div class=" row2">
            ...
            <div class="col-sm-7">
              <textarea type="text" rows="4" name="ketidaksesuaian" class="form-control"   /> </textarea>
            </div>
          </div>
