    ...
    <div class="row align-items-center">
      <div class="col-md-12">
        <div class="page-header-title">
          <h5 class="m-b-10">Informasi Order</h5>
        </div>
      </div>
    </div>
  </div>
</div>
<!-- <label onclick="location.href='<?php echo base_url(); ?>infoorder'" style="font-size: 18px;background-color:#055f5f;color:white" class="btn btn-md  "><i class="fa fa-arrow-left"></i> Kembali</label> -->
<br>
<br>
<br>
<div class="row">
      ...
      <div class="card-body">
        ...
        <div class=" row2">
          ...
          <div class="col-sm-5">
            ...
            <h7>
            <?php if ($data['tgl_pemeriksaan'] == NULL ) {
                  echo "";
                } else {
                  echo format_indo($data['tgl_pemeriksaan']);
                }
                ?></h7>
          </div>
        </div>
  ...
  <div class="col-sm-6">
    <div class="card" style="background-color: #fff;">
      <div class="card-body">
        <div class=" row2" style="background-color: #0b5282;">
          <div class="col-sm-12">
            <h6 style="text-align: left; color:white"><i class="fa fa-check"></i> HASIL PENGERJAAN PETUGAS
            </h6>
          </div>
        </div>
        ...
        <div class=" row2">
          ...
          <div class="col-sm-5">
          <h7>
            <?php if ($data['tgl_mulaidikerjakan'] == NULL ) {
                  echo "";
                } else {
                  echo format_indo($data['tgl_mulaidikerjakan']);
                }
                ?></h7>
          </div>
        </div>
        ...
        <div class=" row2">
          ...
          <div class="col-sm-5">
          <h7>
            <?php if ($data['tgl_selesaidikerjakan'] == NULL ) {
                  echo "";
                } else {
                  echo format_indo($data['tgl_selesaidikerjakan']);
                }
                ?></h7>
        ...
        <!-- <div class=" row2">
          ...
          <div class="col-sm-5">
            <h7><?php echo $data['konfirmasi']; ?></h7>
          </div>
        </div>
