...
<div class="row">
  ...
  <div class="col-sm-6">
    <div class="card" style="background-color: #fff;">
      ...
      <div class="card-body">
        <?php
        echo form_open_multipart('pengerjaan/edit', 'role="form" class="form-horizontal"');
        ?>
  ...
  <div class="col-sm-6">
    <div class="wrapper">
      <div class="card-top">
        <br>
        <h6 style="text-align: center;color:white""> HASIL PENGERJAAN
      </h6>
<br>
      </div>
      <div class=" card-body">
          ...
          <div class=" row2">
            <div class="col-sm-5">
              <h7>Tanggal Mulai Dikerjakan</label>
            </div>
            <div class="col-sm-7">
              <input type="date" class="form-control" name="tgl_mulaidikerjakan" required />
            </div>
          </div>

          <div class=" row2">
            <div class="col-sm-5">
              <h7>Tanggal Selesai Dikerjakan</label>
            </div>
            <div class="col-sm-7">
              <input type="date" class="form-control" name="tgl_selesaidikerjakan" required />
            </div>
          </div>

          <div class=" row2">
            <div class="col-sm-5">
              <h7>Konfirmasi Penyelesaian</h7>
            </div>
            <h7>
              <div class="col-sm-12">
                <div class="form-check">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="konfirmasi" required value="Sesuai"> Sesuai
                  </label>
                </div>
                <div class="form-check">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="konfirmasi" required value="Tidak Sesuai"> Tidak Sesuai/Perbaikan Lanjutan
                  </label>
                </div>
              </div>
          </div>
          ...
          <div class=" row2">
            ...
            <div class="col-sm-7">
              <textarea type="text" rows="10" name="ketidaksesuaian" class="form-control" value="<?php echo $data['estimasi_pengadaan']; ?>" /> </textarea>
            </div>
          </div>
