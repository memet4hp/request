...
<label onclick="location.href='<?php echo base_url(); ?>arsip'" style="font-size: 18px;background-color:#055f5f;color:white" class="btn btn-md  "><i class="fa fa-arrow-left"></i> Kembali</label>
<br>
<br>
<br>
<div class="row">
