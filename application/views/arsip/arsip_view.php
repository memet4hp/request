            ...
            <div class="col-sm-12">
                ...
                <div class="form-row2">
                    ...
                    <div class="form-group col-sm-2">
                        <label class="teks">Pilih Jenis Order</label>
                        <select class="form-control select-filter" id='sel_jenis'>
                ...
                <div class="card-body p-3 mt-2">
                    <div class="">
                        <div class="customer-scroll">
                            <table id="example" class="table  table-bordered  table-hover  nowrap  table-full-width">
                                <thead>
