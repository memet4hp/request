                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" name="user_departement" id="user_department" placeholder="Type User / Department" />
                                <div class="input-group-append">
                                    <button class="btn btn-primary text-hitam" type="submit">Seacrh</button>
                                </div>
                            </div>
                        </div>
