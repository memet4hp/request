<?php
	...
	class User extends CI_Controller
	{
		...
		function index()
		{
			$this->template->load('template/templatedashboard', 'user/view');
		}
		...
		function add()
		{
			if (isset($_POST['submit'])) {
				...
				$this->template->load('template/templatedashboard', 'user/add');
			}
		}
		...
		function edit()
		{
			if (isset($_POST['submit'])) {
				...
				$this->template->load('template/templatedashboard', 'user/edit', $data);
			}
		}
		...
		function rule()
		{
			$this->template->load('template/templatedashboard', 'user/rule');
		}
